...
<header>
    <!--MENU-->
        <ul class="menu">
            ...
            <li><a href="#titulo1">Início</a></li>
            <li><a href="#titulo2">Sobre Nós</a></li>
            <li><a href="#titulo3">Fale Conosco</a></li>
    ...
    <!--PARAGRÁFO-->
    <article>
      <h1 id="titulo1">Com Serotonina você se motiva!</h1>
  ...
  <!-- SOBRE NÓS -->
  <article class="sobre">
    <h1 id="titulo2"><b> Sobre Nós </b></h1>
    ...
    <section class="caixatexto"> 
      <div>
        ...
        <section class="paragrafo-fale-c">
            ...
            <h4 id="mensg-feedback">Escreva sua opinião, sentimento, feedback e muito mais.</h4>
            </div>
